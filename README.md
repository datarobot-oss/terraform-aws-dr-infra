...
| <a name="input_custom_vpc_endpoints"></a> [custom\_vpc\_endpoints](#input\_custom\_vpc\_endpoints) | Configuration for the specific endpoint | <pre>object({<br/>    service_name     = string<br/>    private_dns_zone = optional(string, "")<br/>    private_dns_name = optional(string, "")<br/>  })</pre> | n/a | yes |
