...
| <a name="input_kubernetes_cluster_addons"></a> [kubernetes\_cluster\_addons](#input\_kubernetes\_cluster\_addons) | Map of cluster addon configurations to enable for the cluster. Addon name can be the map keys or set with `name` | `any` | <pre>{<br/>  "coredns": {<br/>    "most_recent": true<br/>  },<br/>  "eks-pod-identity-agent": {<br/>    "before_compute": true,<br/>    "configuration_values": "{\"agent\": {\"additionalArgs\": {\"-b\": \"169.254.170.23\"}}}",<br/>    "most_recent": true<br/>  },<br/>  "kube-proxy": {<br/>    "most_recent": true<br/>  },<br/>  "vpc-cni": {<br/>    "before_compute": true,<br/>    "configuration_values": "{\"enableNetworkPolicy\": \"true\", \"env\": {\"ENABLE_PREFIX_DELEGATION\": \"true\", \"WARM_PREFIX_TARGET\": \"1\"}}",<br/>    "most_recent": true<br/>  }<br/>}</pre> | no |
