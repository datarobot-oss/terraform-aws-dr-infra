...
| <a name="input_cilium"></a> [cilium](#input\_cilium) | Install the cilium helm chart to provide extended cluster networking and security features. All other cilium variables are ignored if this variable is false. | `bool` | `true` | no |
...
| <a name="input_cilium_version"></a> [cilium\_version](#input\_cilium\_version) | Version of the cilium helm chart to install | `string` | `null` | no |
