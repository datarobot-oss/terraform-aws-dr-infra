...
| <a name="input_postgres_egress_cidr_blocks"></a> [postgres\_egress\_cidr\_blocks](#input\_postgres\_egress\_cidr\_blocks) | CIDR blocks allowed for postgres\_egress\_rules | `list(string)` | `[]` | no |
| <a name="input_postgres_egress_rules"></a> [postgres\_egress\_rules](#input\_postgres\_egress\_rules) | List of egress rules to create by name. See https://github.com/terraform-aws-modules/terraform-aws-security-group/blob/master/rules.tf for names. | `list(string)` | `[]` | no |
