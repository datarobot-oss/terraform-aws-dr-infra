...
| <a name="input_postgres_parameters"></a> [postgres\_parameters](#input\_postgres\_parameters) | Parameters to add to the Postgres parameter group | <pre>list(object({<br/>    name  = string<br/>    value = string<br/>  }))</pre> | <pre>[<br/>  {<br/>    "name": "password_encryption",<br/>    "value": "scram-sha-256"<br/>  }<br/>]</pre> | no |
